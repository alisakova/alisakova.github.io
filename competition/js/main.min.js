var accordion=document.querySelector(".accordion"),panel=document.querySelector(".panel");accordion&&accordion.addEventListener("click",function(){this.classList.toggle("active"),panel.style.maxHeight?panel.style.maxHeight=null:panel.style.maxHeight=panel.scrollHeight+"px"});
...
$(document).ready(function(){$("a").on("click",function(e){if(""!==this.hash){e.preventDefault();var t=this.hash;$("html, body").animate({scrollTop:$(t).offset().top},800,function(){window.location.hash=t})}});var o="";document.querySelectorAll(".tooltip").forEach(function(e,t){o=0===t?"Главный приз квартира в Санкт-Петербурге":1===t?"Приз автомобиль BMW 1er":2===t?"Приз автомобиль Smart ForTwo":3===t?"Приз 150 000 руб.":4===t?"Приз 100 000 руб.":5===t?"Приз 50 000 руб.":6===t?"Приз 30 000 руб.":7===t?"Приз 20 000 руб.":8===t?"Приз 15 000 руб.":9<=t&&t<=14?"Приз 10 000 руб.":"Приз 5 000 руб.",640<window.innerWidth&&$(e).tooltipster({animation:"slide",content:o,multiple:!0,side:["left","top"],animationDuration:250,theme:["tooltipster-noir","tooltipster-noir-customized"],trigger:"custom",updateAnimation:null,triggerOpen:{mouseenter:!0,touchstart:!0},triggerClose:{click:!0,scroll:!0,tap:!0,mouseleave:!0}})});new Swiper(".swiper-container",{loop:!0,slidesPerView:2,centeredSlides:!0,effect:"coverflow",autoHeight:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},coverflowEffect:{slidesShadows:!1,depth:250,rotate:0,modifier:1},breakpoints:{640:{slidesPerView:1,effect:"slide",pagination:{el:".swiper-pagination",type:"bullets"}}}})});
